...
export default function HomePage() {
  ...
  useEffect(() => {
    ...
    const savedFormats = localStorage.getItem('authenticatedPlatforms');
    if (savedContent) setContent(savedContent);
    if (savedFormats) setAuthenticatedPlatforms(JSON.parse(savedFormats));
  }, [searchParams]);
  ...
  useEffect(() => {
    localStorage.setItem('authenticatedPlatforms', JSON.stringify(authenticatedPlatforms));
